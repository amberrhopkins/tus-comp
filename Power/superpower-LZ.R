...
mus <- c(0.90, 0.90, 0.90, 0.90, 0.873, 0.873, 0.90, 0.873, 0.873) # predicted cell means based on minimally interesting change in outcome
sd <- 0.026 # rough estimate of population standard deviation taken from the pilot data 
r <- 0.50 # rough estimate of correlation of repeated measures from pilot data 
...
#write.csv(power_simulations_df, "/Users/amber/Documents/PhD/Research/Projects/LIFUP-PCI/Analysis/Power/lz_power_simulations_df.csv", row.names = FALSE)
